...
if __name__ == "__main__":
    ...
    parser.add_argument('--attack', choices=['GSE', 'FWnucl', 'Homotopy', 'StrAttack', 'SAIF', 'SAAPF'], type=str, required=True,
    ...
    # ------------------------------- attacks --------------------------------
    attacks = {'GSE': GSEAttack, 'FWnucl': FWnucl, 'Homotopy': HomotopyAttack, 'StrAttack': StrAttack, 'SAIF': SAIF, 'SAAPF' : SAAPF}
